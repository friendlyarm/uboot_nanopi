 ...
 * NAME	    : s3c2440.h
 *
 * Based on S3C2442A User's manual Rev 1.1
 ************************************************/

#ifndef __S3C2442_H__
#define __S3C2442_H__
...
/* S3C2442 only supports 512 Byte HW ECC */
#define S3C2410_ECCSIZE		512
#define S3C2410_ECCBYTES	3

/* S3C2442 device base addresses */
#define ELFIN_DMA_BASE		0x4b000000
#define ELFIN_USB_DEVICE_BASE	0x52000000
...
#define GPAPU_REG		__REG(ELFIN_GPIO_BASE + GPAPU_OFFSET	)
#define GPASLPCON_REG		__REG(ELFIN_GPIO_BASE + GPASLPCON_OFFSET)
#define GPBCON_REG		__REG(ELFIN_GPIO_BASE + GPBCON_OFFSET	)
#define GPBDAT_REG		__REG(ELFIN_GPIO_BASE + GPBDAT_OFFSET	)
#define GPBPU_REG		__REG(ELFIN_GPIO_BASE + GPBPU_OFFSET	)
#define GPBSLPCON_REG		__REG(ELFIN_GPIO_BASE + GPBSLPCON_OFFSET)
#define GPCCON_REG		__REG(ELFIN_GPIO_BASE + GPCCON_OFFSET	)
#define GPCDAT_REG		__REG(ELFIN_GPIO_BASE + GPCDAT_OFFSET	)
#define GPCPU_REG		__REG(ELFIN_GPIO_BASE + GPCPU_OFFSET	)
#define GPCSLPCON_REG		__REG(ELFIN_GPIO_BASE + GPCSLPCON_OFFSET)
#define GPDCON_REG		__REG(ELFIN_GPIO_BASE + GPDCON_OFFSET	)
#define GPDDAT_REG		__REG(ELFIN_GPIO_BASE + GPDDAT_OFFSET	)
#define GPDPU_REG		__REG(ELFIN_GPIO_BASE + GPDPU_OFFSET	)
#define GPECON_REG		__REG(ELFIN_GPIO_BASE + GPECON_OFFSET	)
#define GPEDAT_REG		__REG(ELFIN_GPIO_BASE + GPEDAT_OFFSET	)
#define GPEPU_REG		__REG(ELFIN_GPIO_BASE + GPEPU_OFFSET	)
#define GPESLPCON_REG		__REG(ELFIN_GPIO_BASE + GPESLPCON_OFFSET)
#define GPFCON_REG		__REG(ELFIN_GPIO_BASE + GPFCON_OFFSET	)
#define GPFDAT_REG		__REG(ELFIN_GPIO_BASE + GPFDAT_OFFSET	)
#define GPFPU_REG		__REG(ELFIN_GPIO_BASE + GPFPU_OFFSET	)
#define GPFSLPCON_REG		__REG(ELFIN_GPIO_BASE + GPFSLPCON_OFFSET)
#define GPGCON_REG		__REG(ELFIN_GPIO_BASE + GPGCON_OFFSET	)
#define GPGDAT_REG		__REG(ELFIN_GPIO_BASE + GPGDAT_OFFSET	)
#define GPGPU_REG		__REG(ELFIN_GPIO_BASE + GPGPU_OFFSET	)
#define GPGSLPCON_REG		__REG(ELFIN_GPIO_BASE + GPGSLPCON_OFFSET)
#define GPHCON_REG		__REG(ELFIN_GPIO_BASE + GPHCON_OFFSET	)
#define GPHDAT_REG		__REG(ELFIN_GPIO_BASE + GPHDAT_OFFSET	)
#define GPHPU_REG		__REG(ELFIN_GPIO_BASE + GPHPU_OFFSET	)
#define GPHSLPCON_REG		__REG(ELFIN_GPIO_BASE + GPHSLPCON_OFFSET)
#define MISCCR_REG		__REG(ELFIN_GPIO_BASE + MISCCR_OFFSET	)
#define GPJCON_REG		__REG(ELFIN_GPIO_BASE + GPJCON_OFFSET	)
#define GPJDAT_REG		__REG(ELFIN_GPIO_BASE + GPJDAT_OFFSET	)
#define GPJPU_REG		__REG(ELFIN_GPIO_BASE + GPJPU_OFFSET	)
#define SPCON_REG		__REG(ELFIN_GPIO_BASE + SPCON_OFFSET	)
#define GPKCON_REG		__REG(ELFIN_GPIO_BASE + GPKCON_OFFSET	)
#define GPKDAT_REG		__REG(ELFIN_GPIO_BASE + GPKDAT_OFFSET	)
#define GPKPU_REG		__REG(ELFIN_GPIO_BASE + GPKPU_OFFSET	)
#define GPKSLPCON_REG		__REG(ELFIN_GPIO_BASE + GPKSLPCON_OFFSET)
#define EINTCON0_REG		__REG(ELFIN_GPIO_BASE + EINTCON0_OFFSET	)
#define EINTCON1_REG		__REG(ELFIN_GPIO_BASE + EINTCON1_OFFSET	)
#define EINTFLT0_REG		__REG(ELFIN_GPIO_BASE + EINTFLT0_OFFSET	)
#define EINTFLT1_REG		__REG(ELFIN_GPIO_BASE + EINTFLT1_OFFSET	)
#define EINTMASK_REG		__REG(ELFIN_GPIO_BASE + EINTMASK_OFFSET	)
#define EINTPEND_REG		__REG(ELFIN_GPIO_BASE + EINTPEND_OFFSET	)
#define DSPGPSLP_REG		__REG(ELFIN_GPIO_BASE + DSPGPSLP_OFFSET	)
#define MEM0CONSTOP_REG		__REG(ELFIN_GPIO_BASE + MEM0CONSTOP_OFFSET)
#define MEM1CONSTOP_REG		__REG(ELFIN_GPIO_BASE + MEM1CONSTOP_OFFSET)
#define MEM2CONSTOP_REG		__REG(ELFIN_GPIO_BASE + MEM2CONSTOP_OFFSET)
#define MEM0CONSLP_REG		__REG(ELFIN_GPIO_BASE + MEM0CONSLP_OFFSET)
#define MEM1CONSLP_REG		__REG(ELFIN_GPIO_BASE + MEM1CONSLP_OFFSET)
#define MEM2CONSLP_REG		__REG(ELFIN_GPIO_BASE + MEM2CONSLP_OFFSET)
#define SPCONSLP_REG		__REG(ELFIN_GPIO_BASE + SPCONSLP_OFFSET	)
#define SLPEN_REG		__REG(ELFIN_GPIO_BASE + SLPEN_OFFSET	)
#define MEM0DRVCON_REG		__REG(ELFIN_GPIO_BASE + MEM0DRVCON_OFFSET)
#define MEM1DRVCON_REG		__REG(ELFIN_GPIO_BASE + MEM1DRVCON_OFFSET)
#define MEM2DRVCON_REG		__REG(ELFIN_GPIO_BASE + MEM2DRVCON_OFFSET)
...
#define NFCMD_REG		__REGb(ELFIN_NAND_BASE + NFCMMD_OFFSET)
#define NFADDR_REG		__REGb(ELFIN_NAND_BASE + NFADDR_OFFSET)
#define NFDATA8_REG		__REGb(ELFIN_NAND_BASE + NFDATA_OFFSET)
#define NFDATA16_REG		__REGw(ELFIN_NAND_BASE + NFDATA_OFFSET)
#define NFDATA32_REG		__REG( ELFIN_NAND_BASE + NFDATA_OFFSET)
